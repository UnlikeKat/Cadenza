...
(function () {
    ...
    var sampleFolder = "",
        samples = {
            "Clementi - Sonatina Op. 36/3 (Excerpt).musicxml": "Clementi_SonatinaOpus36No3_Excerpt.musicxml",
    ...
    function selectSampleOnChange(str) {
        ...
        openSheetMusicDisplay.load(str, comment).then(
            function () {
                ...
                renderAndScrollBack(); // comment out this line to test playback without rendering
            },
            function (e) {
    ...
    var demoPlaybackControl = function(osmd) {
        ...
        // to use a custom server to load the soundfonts, use the following line: (folder where the mp3.js files are hosted)
        // playbackManager.audioPlayer.SoundfontInstrumentOptions.from = "https://my-server.com/fonts/";
        // playbackManager.audioPlayer.SoundfontInstrumentOptions.fromPercussion = "https://my-server.com/fonts/"; // percussion server needs to be set separately
