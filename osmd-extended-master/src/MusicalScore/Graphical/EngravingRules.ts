...
export class EngravingRules {
     ...
     */
    public NeverPlayUnrenderedMeasures: boolean;
    ...
    public InterpolateCursorPositionBetweenNotesDuringPlayback: boolean;
    ...
    public TempoFactors: {[key: string]: number}; // called Decoder in PS
    ...
    public loadDefaultValues(): void {
        ...
        this.CurrentZoom = 1.0; // this is a read-only informational value for OSMD internal use. To set it, use osmd.Zoom = 2
        ...
        this.NeverPlayUnrenderedMeasures = true;
        ...
        // Playback
        this.InterpolateCursorPositionBetweenNotesDuringPlayback = true;
        ...
        this.TempoFactors = {
            "acc":          1.0,    // + beschleunigend
            "accel":        1.0,
            "accelerando":  1.0,    // + beschleunigend
            "piu mosso":    1.0,    // + bewegter
            "poco piu":     1.0,    // + bewegter
            "stretto":      1.0,    // + gesteigert, beschleunigt
            "rubato":       0.0,    // ~ frei
            "precipitando": 0.0,
            "poco meno":   -1.0,
            "meno mosso":  -1.0,
            ...
            "rall":        -1.0,
            "rallentando": -1.0,
            "rit":         -1.0, // TODO this is currently an InstantaneousTempoExpression and doesn't change bpm. see ContinuousTE
            "ritard":      -1.0,
            "ritardando":  -1.0,
            "riten":       -1.0,
            "ritenuto":    -1.0,
