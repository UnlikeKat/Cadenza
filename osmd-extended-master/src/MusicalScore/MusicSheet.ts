...
export class MusicSheet /*implements ISettableMusicSheet, IComparable<MusicSheet>*/ {
    ...
    private playbackDataDict: Dictionary<Voice, { enrolledTimestamp: Fraction, playbackEntry: PlaybackEntry }[]>
        = new Dictionary<Voice, { enrolledTimestamp: Fraction, playbackEntry: PlaybackEntry }[]>();
    ...
    public get PlaybackDataDict(): Dictionary<Voice, { enrolledTimestamp: Fraction, playbackEntry: PlaybackEntry}[]> {
